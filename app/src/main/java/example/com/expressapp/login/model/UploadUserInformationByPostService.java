...
public class UploadUserInformationByPostService implements iPostBack
{
    @Override
    public String save(String username,String password) throws Exception
    {
        String result;
        HttpPost httpRequest=new HttpPost("http://172.28.159.124:8080/Express/AndroidLoginMethod");
        //创建参数
